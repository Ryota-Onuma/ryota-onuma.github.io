...
!(function (e, t) {
      ...
      e: if ("function" == typeof w) {
        if (
          ...
          null != w.getDerivedStateFromProps &&
            ...
            _(f.__s, w.getDerivedStateFromProps(y, f.__s))),
          (m = f.props),
          (d = f.state),
          p)
        )
        ...
        (f.context = g),
          ...
          p ||
            ...
            (h = f.getSnapshotBeforeUpdate(m, d)),
          (O =
  ...
  function M(e, t, n, r, o, c, i, a) {
    ...
    if (null === d) p === m || (a && e.data === m) || (e.data = m);
      ...
      if (
        ...
        (l = (p = n.props || h).dangerouslySetInnerHTML),
      ...
      if (
        ((function (e, t, n, r, o) {
          var c;
          for (c in n)
            "children" === c || "key" === c || c in t || N(e, c, null, n[c], r);
          for (c in t)
  ...
  s.vnode = function (e) {
    ...
    t &&
      n.class != n.className &&
      ((qe.enumerable = "className" in n),
      null != n.className && (r.class = n.className),
      Object.defineProperty(r, "className", qe)),
      (e.$$typeof = ke),
      Me && Me(e);
  };
  var He = s.__r;
    ...
    return (
      oe(function () {
        "undefined" != typeof navigator &&
          (/(Mac|iPhone|iPod|iPad)/i.test(navigator.platform) ? f("⌘") : f(Ye));
      }, []),
      Be.createElement(
        "button",
        Ke(
          ...
          null !== s &&
            Be.createElement(
              ...
              Be.createElement(
                ...
                s === Ye ? Be.createElement(Ve, null) : s,
              ),
              Be.createElement(
                "kbd",
                { className: "DocSearch-Button-Key" },
  ...
  function yt(e, t, n) {
    ...
    return {
      ...
      dispatch: function (r, c) {
        ...
        (o = e(o, { type: r, props: t, payload: c })),
          n({ state: o, prevState: i });
      },
      pendingRequests:
        ((r = []),
        {
  ...
  function $t(e) {
    ...
    var y = ot(
      Jt(
        o
          .getSources(Ut({ query: c, refresh: i, state: a.getState() }, u))
          .then(function (e) {
            return Promise.all(
              e.map(function (e) {
                return Promise.resolve(
                  e.getItems(
                    Ut({ query: c, refresh: i, state: a.getState() }, u),
                  ),
                ).then(function (t) {
        ...
        return an(
          {
            ...
            onSubmit: function (c) {
              ...
              c.preventDefault(),
                t.onSubmit(
                  an({ event: c, refresh: n, state: r.getState() }, o),
                ),
            ...
            onReset: function (c) {
              var i;
              c.preventDefault(),
                t.onReset(an({ event: c, refresh: n, state: r.getState() }, o)),
      ...
      getInputProps: function (e) {
        ...
        var a = e || {},
          ...
          p = (function (e) {
            ...
            (null === (c = t.environment.navigator) || void 0 === c
              ? void 0
              : c.userAgent) || "",
          ),
  ...
  function dn(e) {
    var t,
      ...
      a =
        null ===
          (t = ((null === (n = i.__autocomplete_metadata) || void 0 === n
            ? void 0
      ...
      u = a
        ? mn(
            ...
            a,
            Object.keys(
              (null === (r = i.__autocomplete_metadata) || void 0 === r
                ? void 0
                : r.options) || {},
            ),
          )
    ...
    return {
      ...
      ua: nt.concat(
        (null === (o = i.__autocomplete_metadata) || void 0 === o
          ? void 0
          : o.userAgents) || [],
      ),
    };
  ...
  function hn(e) {
    ...
    return !1 === n.isOpen || null === n.activeItemId
      ? null
      : (null === (t = st(n)) || void 0 === t ? void 0 : t.itemInputValue) ||
          null;
  }
  function vn(e, t) {
    var n = Object.keys(e);
    ...
    switch (t.type) {
        ...
        var n = yn(
          ...
          {},
          {
            activeItemId: t.payload.hasOwnProperty("nextActiveItemId")
              ...
              : it(1, e.activeItemId, et(e), t.props.defaultActiveItemId),
          },
        );
      ...
      case "blur":
        return t.props.debug
          ? e
          : yn(yn({}, e), {}, { isOpen: !1, activeItemId: null });
      case "mouseleave":
  ...
  function Pn(e) {
    ...
    return Be.createElement(
      ...
      Be.createElement(
        ...
        Be.createElement(wn, { translations: { searchByText: _ } }),
      ),
      Be.createElement(
        "ul",
  ...
  function Hn(e) {
    ...
    return Be.createElement(
      ...
      Be.createElement(
        ...
        Be.createElement(qn, null),
      ),
      Be.createElement("p", { className: "DocSearch-Title" }, o),
      Be.createElement("p", { className: "DocSearch-Help" }, i),
    );
  }
  var Un = ["translations"];
  function Fn(e) {
            ...
            renderIcon: function (e) {
              ...
              return Be.createElement(
                ...
                Be.createElement(
                  ...
                  Be.createElement(Nn, { type: r.type }),
                ),
              );
            },
    ...
    return (
      ...
      Be.createElement(
        ...
        Be.createElement(
          ...
          Be.createElement(
            "label",
            gr({ className: "DocSearch-MagnifierLabel" }, r.getLabelProps()),
            Be.createElement(ze, null),
          ),
          Be.createElement(
            "div",
            { className: "DocSearch-LoadingIndicator" },
            Be.createElement(kn, null),
          ),
          Be.createElement(
            "input",
            gr(
          ...
          h = {
            ...
            onRetry: function (r) {
              ...
              return (
                r.isTimedOut && p++,
                Promise.all([
                  e.logger.info("Retryable failure", Zr(o)),
                  e.hostsCache.set(s, Br(s, r.isTimedOut ? Ur : Hr)),
                ]).then(function () {
                  return t(n, a);
                })
              );
  ...
  function go(e) {
    var t = e.appId,
      ...
      F = (function (e, t, n) {
        return Be.useMemo(
          function () {
            var r = lo(e, t);
            return (
              r.addAlgoliaAgent("docsearch", so),
              !1 ===
                /docsearch.js \(.*\)/.test(r.transporter.userAgent.value) &&
                r.addAlgoliaAgent("docsearch-react", so),
              n(r)
            );
          },
          [e, t, n],
      ...
      B = Be.useRef(
        Pr({ key: "__DOCSEARCH_FAVORITE_SEARCHES__".concat(r), limit: 10 }),
      ).current,
      V = Be.useRef(
        Pr({
                    ...
                    .then(function (e) {
                      ...
                      return (
                        n.context.searchSuggestions.length <
                          ...
                          o({ searchSuggestions: Object.keys(i) }),
                        o({ nbHits: c }),
      ...
      Be.createElement(
        ...
        po({ ref: N }, J({ "aria-expanded": !0 }), {
          className: [
            "DocSearch",
            "DocSearch-Container",
            "stalled" === A.status && "DocSearch-Container--Stalled",
            "error" === A.status && "DocSearch-Container--Errored",
          ]
            .filter(Boolean)
            .join(" "),
          role: "button",
        ...
        Be.createElement(
          ...
          Be.createElement(
            ...
            Be.createElement(Pn, { translations: I }),
          ),
        ),
      )
    );
      ...
      Be.createElement(
        ...
        o({}, e, {
          transformSearchClient: function (t) {
            return (
              t.addAlgoliaAgent("docsearch.js", so),
