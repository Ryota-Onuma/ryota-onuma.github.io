/*! @docsearch/js 3.2.0 | MIT License | © Algolia, Inc. and contributors | https://docsearch.algolia.com | https://cdn.jsdelivr.net/npm/@docsearch/js@3 */
!(function (e, t) {
  ...
  function g(e, t, n) {
    ...
    if (arguments.length > 3) for (n = [n], c = 3; c < arguments.length; c++) n.push(i[c]);
    if ((null != n && (a.children = n), 'function' == typeof e && null != e.defaultProps)) for (c in e.defaultProps) void 0 === a[c] && (a[c] = e.defaultProps[c]);
  ...
  function k(e, t, n, r, o, c, i, a, u, l) {
    ...
    for (n.__k = [], s = 0; s < t.length; s++)
      if (null != (m = n.__k[s] = null == (m = t[s]) || 'boolean' == typeof m ? null : 'string' == typeof m || 'number' == typeof m ? O(null, m, null, null, m) : Array.isArray(m) ? O(S, { children: m }, null, null, null) : m.__b > 0 ? O(m.type, m.props, m.key, null, m.__v) : m)) {
        ...
        L(e, m, (p = p || h), o, c, i, a, u, l),
          (d = m.__e),
          (f = m.ref) && p.ref != f && (_ || (_ = []), p.ref && _.push(p.ref, null, m), _.push(f, m.__c || d, m)),
          null != d ? (null == y && (y = d), 'function' == typeof m.type && null != m.__k && m.__k === p.__k ? (m.__d = u = D(m, u, e)) : (u = A(e, m, p, b, d, u)), l || 'option' !== n.type ? 'function' == typeof n.type && (n.__d = u) : (e.value = '')) : u && p.__e == u && u.parentNode != e && (u = w(p));
      }
  ...
  function A(e, t, n, r, o, c) {
    ...
    if (void 0 !== t.__d) (i = t.__d), (t.__d = void 0);
      ...
      e: if (null == c || c.parentNode !== e) e.appendChild(o), (i = null);
        ...
        for (a = c, u = 0; (a = a.nextSibling) && u < r.length; u += 2) if (a == o) break e;
  ...
  function N(e, t, n, r, o) {
    ...
    e: if ('style' === t)
      if ('string' == typeof n) e.style.cssText = n;
        ...
        if (('string' == typeof r && (e.style.cssText = r = ''), r)) for (t in r) (n && t in n) || x(e.style, t, '');
    ...
    try {
      e: if ('function' == typeof w) {
        if (
          ...
          n.__c ? (v = (f = t.__c = n.__c).__ = f.__E) : ('prototype' in w && w.prototype.render ? (t.__c = f = new w(y, g)) : ((t.__c = f = new E(y, g)), (f.constructor = w), (f.render = F)), b && b.sub(f), (f.props = y), f.state || (f.state = {}), (f.context = g), (f.__n = r), (p = f.__d = !0), (f.__h = [])),
          null == f.__s && (f.__s = f.state),
          null != w.getDerivedStateFromProps && (f.__s == f.state && (f.__s = _({}, f.__s)), _(f.__s, w.getDerivedStateFromProps(y, f.__s))),
          (m = f.props),
          (d = f.state),
          p)
        )
        ...
        (f.context = g),
          ...
          p || null == f.getSnapshotBeforeUpdate || (h = f.getSnapshotBeforeUpdate(m, d)),
          (O = null != l && l.type === S && null == l.key ? l.props.children : l),
          k(e, Array.isArray(O) ? O : [O], t, n, r, o, c, i, a, u),
          (f.base = t.__e),
          (t.__h = null),
  ...
  function M(e, t, n, r, o, c, i, a) {
    ...
    if (null === d) p === m || (a && e.data === m) || (e.data = m);
      ...
      if (((c = c && v.slice.call(e.childNodes)), (l = (p = n.props || h).dangerouslySetInnerHTML), (s = m.dangerouslySetInnerHTML), !a)) {
        if (null != c) for (p = {}, f = 0; f < e.attributes.length; f++) p[e.attributes[f].name] = e.attributes[f].value;
      ...
      if (
        ...
        t.__k = [];
      else if (((y = t.props.children), k(e, Array.isArray(y) ? y : [y], t, n, r, o && 'foreignObject' !== d, c, i, e.firstChild, a), null != c)) for (y = c.length; y--; ) null != c[y] && b(c[y]);
  ...
  ((he.prototype = new E()).isPureReactComponent = !0),
            ...
            return (
              t &&
                (t.__c &&
                  ...
                  (t.__c.__H = null)),
                null != (t = me({}, t)).__c && (t.__c.__P === r && (t.__c.__P = n), (t.__c = null)),
                (t.__k =
                  t.__k &&
                  t.__k.map(function (t) {
                    return e(t, n, r);
  ...
  ((Ee.prototype = new E()).__e = function (e) {
    ...
    (Ee.prototype.componentDidUpdate = Ee.prototype.componentDidMount =
      function () {
        var e = this;
  ...
  function ze() {
    return Be.createElement('i', {
      className: 'icon icon-search DocSearch-Search-Icon',
    });
  }
  var We = ['translations'];
  function Ke() {
  ...
  var Ge = Be.forwardRef(function (e, t) {
    ...
    return (
      ...
      Be.createElement(
        ...
        Be.createElement('span', { className: 'DocSearch-Button-Container' }, Be.createElement(ze, null), Be.createElement('span', { className: 'DocSearch-Button-Placeholder' }, i)),
        Be.createElement('span', { className: 'DocSearch-Button-Keys' }, null !== s && Be.createElement(Be.Fragment, null, Be.createElement('kbd', { className: 'DocSearch-Button-Key' }, s === Ye ? Be.createElement(Ve, null) : s), Be.createElement('kbd', { className: 'DocSearch-Button-Key' }, 'K'))),
      )
    );
  });
  function Ze(e) {
  ...
  var tt = function () {},
    nt = [{ segment: 'autocomplete-core', version: '1.7.1' }];
  function rt(e, t) {
    var n = t;
    return {
      then: function (t, r) {
  ...
  function ot(e) {
    return rt(e, { isCanceled: !1, onCancelList: [] });
  }
  function ct(e, t, n) {
    return e
      ? function (n) {
  ...
  function yt(e, t, n) {
    ...
    return {
      ...
      dispatch: function (r, c) {
        ...
        (o = e(o, { type: r, props: t, payload: c })), n({ state: o, prevState: i });
      },
      pendingRequests:
        ((r = []),
        {
    ...
    var t = e
      .reduce(function (e, t) {
        ...
        if (i) {
          ...
          var u = { execute: r, requesterId: o, items: c, searchClient: n };
          e.push(u);
        }
        return e;
      }, [])
  ...
  function $t(e) {
    ...
    if ((f(c), p(o.defaultActiveItemId), !c && !1 === o.openOnFocus)) {
      var d,
        h = a.getState().collections.map(function (e) {
          return Ut(Ut({}, e), {}, { items: [] });
        });
      m('idle'), l(h), s(null !== (d = r.isOpen) && void 0 !== d ? d : o.shouldPanelOpen({ state: a.getState() }));
      var v = ot(
        Jt(h).then(function () {
    ...
    m('loading'),
      (Kt = o.environment.setTimeout(function () {
        m('stalled');
      }, o.stallThreshold));
    var y = ot(
      Jt(
        o.getSources(Ut({ query: c, refresh: i, state: a.getState() }, u)).then(function (e) {
          return Promise.all(
            e.map(function (e) {
              return Promise.resolve(e.getItems(Ut({ query: c, refresh: i, state: a.getState() }, u))).then(function (t) {
  ...
  function sn(e) {
    ...
    return {
        ...
        return an(
          {
            ...
            onSubmit: function (c) {
              var i;
              c.preventDefault(), t.onSubmit(an({ event: c, refresh: n, state: r.getState() }, o)), r.dispatch('submit', null), null === (i = e.inputElement) || void 0 === i || i.blur();
            },
            onReset: function (c) {
              var i;
              c.preventDefault(), t.onReset(an({ event: c, refresh: n, state: r.getState() }, o)), r.dispatch('reset', null), null === (i = e.inputElement) || void 0 === i || i.focus();
            },
          },
          ln(e, nn),
        );
      ...
      getLabelProps: function (e) {
        return an({ htmlFor: ''.concat(t.id, '-input'), id: ''.concat(t.id, '-label') }, e);
      },
            ...
            onKeyDown: function (e) {
              !(function (e) {
                ...
                if ('ArrowUp' === t.key || 'ArrowDown' === t.key) {
                  ...
                  t.preventDefault(),
                    !1 === o.getState().isOpen && (n.openOnFocus || Boolean(o.getState().query))
                      ? $t(
                          Gt(
                            {
                              event: t,
              ...
              })(an({ event: e, props: t, refresh: n, store: r }, o));
            },
            onFocus: i,
            onBlur: tt,
            onClick: function (n) {
  ...
  function dn(e) {
    ...
    return {
      ...
      options: pn({ 'autocomplete-core': Object.keys(i) }, u),
  ...
  var bn = function (e, t) {
    switch (t.type) {
      ...
      case 'mousemove':
        return yn(yn({}, e), {}, { activeItemId: t.payload });
      case 'setQuery':
        return yn(yn({}, e), {}, { query: t.payload, completion: null });
      case 'setCollections':
        return yn(yn({}, e), {}, { collections: t.payload });
      case 'setIsOpen':
        return yn(yn({}, e), {}, { isOpen: t.payload });
      case 'setStatus':
        return yn(yn({}, e), {}, { status: t.payload });
      case 'setContext':
        return yn(yn({}, e), {}, { context: yn(yn({}, e.context), t.payload) });
      case 'ArrowDown':
        var n = yn(
          yn({}, e),
          {},
        ...
        return yn(yn({}, n), {}, { completion: hn({ state: n }) });
      case 'ArrowUp':
        var r = yn(
          yn({}, e),
          {},
        ...
        return yn(yn({}, r), {}, { completion: hn({ state: r }) });
      case 'Escape':
        return e.isOpen
          ? yn(yn({}, e), {}, { activeItemId: null, isOpen: !1, completion: null })
          : yn(
              yn({}, e),
              {},
              {
      ...
      case 'submit':
        return yn(yn({}, e), {}, { activeItemId: null, isOpen: !1, status: 'idle' });
      case 'reset':
        return yn(
          yn({}, e),
          {},
      ...
      case 'blur':
        return t.props.debug ? e : yn(yn({}, e), {}, { isOpen: !1, activeItemId: null });
      case 'mouseleave':
        return yn(yn({}, e), {}, { activeItemId: t.props.defaultActiveItemId });
      default:
  ...
  function En(e) {
    var t = [],
      ...
      r = yt(bn, n, function (e) {
        var t = e.prevState,
          r = e.state;
        n.onStateChange(On({ prevState: t, state: r, refresh: i }, o));
      }),
      o = (function (e) {
        var t = e.store;
        return {
                ...
                return bt(
                  ...
                  {},
                  {
                    items: Ze(e.items).map(function (e) {
                      return bt(bt({}, e), {}, { __autocomplete_id: n++ });
                    }),
                  },
                );
              });
      ...
      c = sn(On({ props: n, refresh: i, store: r }, o));
    function i() {
      return $t(
        On(
          {
    ...
    return (
      ...
      (function (e) {
        ...
        if (null === (t = o.navigator) || void 0 === t || null === (n = t.userAgent) || void 0 === n ? void 0 : n.includes('Algolia Crawler')) {
          ...
          (c.name = 'algolia:metadata'),
            setTimeout(function () {
              (c.content = JSON.stringify(r)), i.appendChild(c);
            }, 0);
        }
      })({
        metadata: dn({ plugins: n.plugins, options: e }),
  ...
  function wn(e) {
    ...
    return Be.createElement(
      ...
      Be.createElement(
        'svg',
        { width: '77', height: '19', 'aria-label': 'Algolia', role: 'img' },
        Be.createElement('path', {
  ...
  function Pn(e) {
    ...
    return Be.createElement(
      Be.Fragment,
      null,
      Be.createElement('div', { className: 'DocSearch-Logo' }, Be.createElement(wn, { translations: { searchByText: _ } })),
      Be.createElement(
        'ul',
        ...
        Be.createElement(
          'li',
          null,
          Be.createElement('kbd', { className: 'DocSearch-Commands-Key' }, Be.createElement(jn, { ariaLabel: p }, Be.createElement('path', { d: 'M7.5 3.5v8M10.5 8.5l-3 3-3-3' }))),
          Be.createElement('kbd', { className: 'DocSearch-Commands-Key' }, Be.createElement(jn, { ariaLabel: s }, Be.createElement('path', { d: 'M7.5 11.5v-8M10.5 6.5l-3-3-3 3' }))),
  ...
  function Hn(e) {
    ...
    return Be.createElement('div', { className: 'DocSearch-ErrorScreen' }, Be.createElement('div', { className: 'DocSearch-Screen-Icon' }, Be.createElement(qn, null)), Be.createElement('p', { className: 'DocSearch-Title' }, o), Be.createElement('p', { className: 'DocSearch-Help' }, i));
  }
  var Un = ['translations'];
  function Fn(e) {
    return (
  ...
  function zn(e) {
    ...
    return Be.createElement(
      ...
      Be.createElement('div', { className: 'DocSearch-Screen-Icon' }, Be.createElement(Mn, null)),
      Be.createElement('p', { className: 'DocSearch-Title' }, c, ' "', Be.createElement('strong', null, r.state.query), '"'),
      p &&
        p.length > 0 &&
        Be.createElement(
          'div',
  ...
  function tr(e) {
    return e.collection && 0 !== e.collection.items.length
      ? Be.createElement(
          ...
          Be.createElement('div', { className: 'DocSearch-Hit-source' }, e.title),
          Be.createElement(
            'ul',
            e.getListProps(),
            e.collection.items.map(function (t, n) {
              return Be.createElement(nr, er({ key: [e.title, t.objectID].join(':'), item: t, index: n }, e));
            }),
          ),
        )
      : null;
                ...
                r.__docsearch_parent &&
                  Be.createElement(
                    ...
                    Be.createElement(
                      ...
                      r.__docsearch_parent !== (null === (n = t.items[o + 1]) || void 0 === n ? void 0 : n.__docsearch_parent) ? Be.createElement('path', { d: 'M8 6v21M20 27H8.3' }) : Be.createElement('path', { d: 'M8 6v42M20 27H8.3' }),
                    ),
                  ),
                Be.createElement('div', { className: 'DocSearch-Hit-icon' }, Be.createElement(Nn, { type: r.type })),
              );
            },
            renderAction: function () {
              return Be.createElement('div', { className: 'DocSearch-Hit-action' }, Be.createElement(An, null));
            },
          }),
        );
      }),
      e.resultsFooterComponent && Be.createElement('section', { className: 'DocSearch-HitsFooter' }, Be.createElement(e.resultsFooterComponent, { state: e.state })),
    );
  }
  var fr = ['translations'];
  function pr() {
  ...
  function dr(e) {
    ...
    return 'idle' === r.state.status && !1 === r.hasCollections
      ? r.disableUserPersonalization
        ? null
        : Be.createElement('div', { className: 'DocSearch-StartScreen' }, Be.createElement('p', { className: 'DocSearch-Help' }, a))
      : !1 === r.hasCollections
      ? null
      : Be.createElement(
          'div',
          ...
          Be.createElement(
            ...
            pr({}, r, {
              ...
              renderIcon: function () {
                return Be.createElement('div', { className: 'DocSearch-Hit-icon' }, Be.createElement(Dn, null));
              },
          ...
          Be.createElement(
            ...
            pr({}, r, {
              ...
              renderIcon: function () {
                return Be.createElement('div', { className: 'DocSearch-Hit-icon' }, Be.createElement(Ln, null));
              },
              renderAction: function (e) {
                var t = e.item,
    ...
    return (
      ...
      Be.createElement(
        ...
        Be.createElement(
          ...
          Be.createElement('label', gr({ className: 'DocSearch-MagnifierLabel' }, r.getLabelProps()), Be.createElement(ze, null)),
          Be.createElement('div', { className: 'DocSearch-LoadingIndicator' }, Be.createElement(kn, null)),
          Be.createElement(
            'input',
            gr(
      ...
      : {
          get: function (e, r) {
            ...
            return n.get(e, r, o).catch(function () {
              return Dr({ caches: t }).get(e, r, o);
            });
          },
          set: function (e, r) {
            return n.set(e, r).catch(function () {
              return Dr({ caches: t }).set(e, r);
            });
          },
          delete: function (e) {
            return n.delete(e).catch(function () {
              return Dr({ caches: t }).delete(e);
            });
          },
          clear: function () {
            return n.clear().catch(function () {
              return Dr({ caches: t }).clear();
            });
          },
        };
  }
  ...
  var Rr = '4.8.5',
    Tr = { WithinQueryParameters: 0, WithinHeaders: 1 };
  function Lr(e, t) {
    var n = e || {},
      r = n.data || {};
    return (
  ...
  function Vr(e) {
    return 'string' == typeof e
      ? { protocol: 'https', url: e, accept: qr.Any }
      : {
  ...
  function Jr(e, n, r, o) {
    var c = [],
      ...
      f = t(t(t({ 'x-algolia-agent': e.userAgent.value }, e.queryParameters), s), o.queryParameters),
      p = 0,
      m = function t(n, a) {
        var s = n.pop();
        if (void 0 === s)
        ...
        var m = {
          ...
          h = {
            ...
            onRetry: function (r) {
              ...
              return (
                r.isTimedOut && p++,
                Promise.all([e.logger.info('Retryable failure', Zr(o)), e.hostsCache.set(s, Br(s, r.isTimedOut ? Ur : Hr))]).then(function () {
                  return t(n, a);
                })
              );
            },
  ...
  function Zr(e) {
    ...
    return t(
      ...
      {},
      {
        request: t(t({}, e.request), {}, { headers: t(t({}, e.request.headers), n) }),
      },
    );
  }
  var Xr = function (e) {
        ...
        o = (function (e) {
          ...
          t(
            t(
              {
                hosts: [
                  { url: ''.concat(n, '-dsn.algolia.net'), accept: qr.Read },
                  { url: ''.concat(n, '.algolia.net'), accept: qr.Write },
                ].concat(Ar([{ url: ''.concat(n, '-1.algolianet.com') }, { url: ''.concat(n, '-2.algolianet.com') }, { url: ''.concat(n, '-3.algolianet.com') }])),
              },
              e,
            ),
            {},
    ...
    to = function (e) {
      return function (n, r) {
        var o = n.map(function (e) {
          return t(t({}, e), {}, { params: Yr(e.params || {}) });
        });
        ...
        return Promise.all(
          n.map(function (n) {
            ...
            return eo(e)(n.indexName, {
              methods: { searchForFacetValues: co },
  ...
  function lo(e, n, r) {
    var o,
      c = {
        ...
        responsesCache: Cr(),
        requestsCache: Cr({ serializable: !1 }),
        hostsCache: Dr({
          caches: [kr({ key: ''.concat(Rr, '-').concat(e) }), Cr()],
        }),
        userAgent: $r(Rr).add({ segment: 'Browser', version: 'lite' }),
  ...
  function go(e) {
    var t = e.appId,
      ...
      B = Be.useRef(Pr({ key: '__DOCSEARCH_FAVORITE_SEARCHES__'.concat(r), limit: 10 })).current,
      V = Be.useRef(
        Pr({
              ...
              return t
                ? F.search([
                    ...
                    .then(function (e) {
                      ...
                      return (
                        n.context.searchSuggestions.length < Object.keys(i).length && o({ searchSuggestions: Object.keys(i) }),
                        o({ nbHits: c }),
    ...
    return (
      ...
      Be.createElement(
        ...
        Be.createElement(
          ...
          Be.createElement(
            'header',
            { className: 'DocSearch-SearchBar', ref: T },
            Be.createElement(
              Sr,
              po({}, W, {
                state: A,
          ...
          Be.createElement(
            'div',
            { className: 'DocSearch-Dropdown', ref: L },
            Be.createElement(
              _r,
              po({}, W, {
                indexName: r,
          ...
          Be.createElement('footer', { className: 'DocSearch-Footer' }, Be.createElement(Pn, { translations: I })),
        ),
      )
    );
  }
          ...
          function () {
            function e(e) {
              ((27 === e.keyCode && t) ||
                ...
                c && c.current === document.activeElement && o && /[a-zA-Z0-9]/.test(String.fromCharCode(e.keyCode)) && o(e);
            }
            return (
