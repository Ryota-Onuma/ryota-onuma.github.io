...
const getColorPreference = () => {
  ...
  if (lastUsedColorPreference !== null) return lastUsedColorPreference;
  else
...
const getColorPreferenceDarkVariant = () => {
  let lastUsedColorPreferenceDarkVariant = localStorage.getItem(
    lsKeyColorPreferenceDarkVariant,
  );
  return lastUsedColorPreferenceDarkVariant !== null
    ? lastUsedColorPreferenceDarkVariant
    : "dark";
};
